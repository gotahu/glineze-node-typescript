...
import { SesameDeviceStatus, SesameLockStatus } from '../../types/types';
import { logger } from '../../utils/logger';

interface SesameDiscordDependencies {
...
export class SesameDiscordService {
  constructor(private readonly services: SesameDiscordDependencies) {}
